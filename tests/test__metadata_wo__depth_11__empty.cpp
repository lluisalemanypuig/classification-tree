...
{
	classtree::ctree<d11, void, level_types> kd;
	...
	SUBCASE("Iterate over a range forward")
	{
		...
		// clang-format off
		const auto f1 = [](const int v) -> bool { return v == 1; };
		const auto f2 = [](const int v) -> bool { return v == 1; };
		const auto f3 = [](const int v) -> bool { return v == 1; };
		const auto f4 = [](const int v) -> bool { return v == 1; };
		const auto f5 = [](const int v) -> bool { return v == 1; };
		const auto f6 = [](const int v) -> bool { return v == 1; };
		const auto f7 = [](const int v) -> bool { return v == 1; };
		const auto f8 = [](const int v) -> bool { return v == 1; };
		const auto f9 = [](const int v) -> bool { return v == 1; };
		const auto f10 = [](const int v) -> bool { return v == 1; };
